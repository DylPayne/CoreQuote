...
# Add shared package to path for local Streamlit runs
sys.path.append(os.path.join(os.getcwd(), "packages", "corequote-core"))

from corequote_core.logic import get_door_panel_list, get_draw_panel_list
from corequote_core.units import DoorUnit, DrawerUnit
from corequote_core.models import Slide
from corequote_core.pdf_gen import generate_pdf
from corequote_core.database import get_all_slides
